...
const Home = ()=>{
    ...
    return <div id='home' className='h-[85vh] flex items-center max-[500px]:pl-5  pl-52 max-[1700px]:pl-40  max-[1100px]:pl-10'>
            ...
            <div className='  '>
                    ...
                    <h2 className='text-[2.2rem] max-[1600px]:text-[2rem] max-[1500px]:text-[1.8rem] max-[1000px]:text-[1.3rem] max-[500px]:text-[1.2rem]'>And I, am a  <ReactTyped className='uppercase text-[crimson]' strings={["UI/UX DESIGNER","Web Designer","Android Developer","Fullstack Developer",]} loop typeSpeed={30} /> </h2>
